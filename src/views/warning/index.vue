<template>
  <div class="common_content warn_content">
    ...
    <el-table :data="tableData" style="width: 100%" border stripe :show-overflow-tooltip="true" class="content_table">
      ...
      <el-table-column align="center" prop="Title" label="Title" min-width="100"></el-table-column>
      <el-table-column align="center" prop="Content" label="Content" min-width="120"></el-table-column>
      ...
      <el-table-column align="center" prop="NotifyCount" label="NotifyCount" min-width="120"></el-table-column>
      <el-table-column align="center" prop="Reason" label="Reason" min-width="120" v-if="unclose"></el-table-column>
      <el-table-column align="center" prop="ClosedAt" label="ClosedAt" min-width="120" v-if="unclose"></el-table-column>
      <el-table-column align="center" prop="Closer" label="Closer" min-width="120" v-if="unclose"></el-table-column>
    ...
    <footer>
      <el-pagination background layout="prev, pager, next" :total="total" :page-size="pageSize"
        :current-page="currentPage" @current-change="pageChange"></el-pagination>
    </footer>
